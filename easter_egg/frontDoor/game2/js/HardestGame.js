...
(function () {
    ...
    //旋转半径
    var ROTATION_RADIUS = Math.max(CANVAS_HEIGHT * 0.25, CANVAS_WIDTH * 0.5 - 40);/*0.25  40*/
    //旋转中心
...
/**		var bg_img= new Image();
		bg_img.src = "images/Tang.png";
		var pat=this.createPattern(bg_img,"repeat");**/			
...
/*			var bg_img= new Image();
			bg_img.src = "images/Hulu.png";
			var pat=context.createPattern(bg_img,"no-repeat");*/
            context.fillStyle = this.fillStyle;/*this.fillStyle*/
            context.beginPath();
    ...
    CircleRotation.prototype.paint = function (context){
        context.save();
/*		var ag_img= new Image();
		ag_img.src = "images/Hulu.png";
		var pat=context.createPattern(ag_img,"repeat");		*/
        context.strokeStyle = this.strokeStyle?this.strokeStyle:"#ffaf5a";
        context.lineWidth = 1;
	...
	/**跟随旋转的半径不一样的小圆**/
    function CircleRotation2(angle,fillStyle, strokeStyle){
        this.super.call(this, 0,0,RADIUS_SMALL,fillStyle, strokeStyle);
        this.angle = angle;
        this.resetPosition();
    };
    extendClass(CircleRotation2, Circle);
    CircleRotation2.prototype.update = function (rs){
        this.angle += rs;
        this.resetPosition();
    };
    CircleRotation2.prototype.resetPosition = function (){
        this.x = ROTATION_CENTER.x + (ROTATION_RADIUS-20) * Math.cos(this.angle);
        this.y = ROTATION_CENTER.y + (ROTATION_RADIUS-20) * Math.sin(this.angle);
    };
    CircleRotation2.prototype.paint = function (context){
        context.save();
/*		var ag_img= new Image();
		ag_img.src = "images/Hulu.png";
		var pat=context.createPattern(ag_img,"repeat");		*/
	...
	/**跟随旋转的半径不一样的小圆**/
    function CircleRotation3(angle,fillStyle, strokeStyle){
        this.super.call(this, 0,0,RADIUS_SMALL,fillStyle, strokeStyle);
        this.angle = angle;
        this.resetPosition();
    };
    extendClass(CircleRotation3, Circle);
    CircleRotation3.prototype.update = function (rs){
        this.angle += rs;
        this.resetPosition();
    };
    CircleRotation3.prototype.resetPosition = function (){
        this.x = ROTATION_CENTER.x + (ROTATION_RADIUS-40) * Math.cos(this.angle);
        this.y = ROTATION_CENTER.y + (ROTATION_RADIUS-40) * Math.sin(this.angle);
    };
    CircleRotation3.prototype.paint = function (context){
        context.save();
/*		var ag_img= new Image();
		ag_img.src = "images/Hulu.png";
		var pat=context.createPattern(ag_img,"repeat");		*/
	...
	/**跟随旋转的半径不一样的小圆**/
    function CircleRotation4(angle,fillStyle, strokeStyle){
        this.super.call(this, 0,0,RADIUS_SMALL,fillStyle, strokeStyle);
        this.angle = angle;
        this.resetPosition();
    };
    extendClass(CircleRotation4, Circle);
    CircleRotation4.prototype.update = function (rs){
        this.angle += rs;
        this.resetPosition();
    };
    CircleRotation4.prototype.resetPosition = function (){
        this.x = ROTATION_CENTER.x + (ROTATION_RADIUS-60) * Math.cos(this.angle);
        this.y = ROTATION_CENTER.y + (ROTATION_RADIUS-60) * Math.sin(this.angle);
    };
    CircleRotation4.prototype.paint = function (context){
        context.save();
/*		var ag_img= new Image();
		ag_img.src = "images/Hulu.png";
		var pat=context.createPattern(ag_img,"repeat");		*/
	...
	/**跟随旋转的半径不一样的小圆**/
    function CircleRotation5(angle,fillStyle, strokeStyle){
        this.super.call(this, 0,0,RADIUS_SMALL,fillStyle, strokeStyle);
        this.angle = angle;
        this.resetPosition();
    };
    extendClass(CircleRotation5, Circle);
    CircleRotation5.prototype.update = function (rs){
        this.angle += rs;
        this.resetPosition();
    };
    CircleRotation5.prototype.resetPosition = function (){
        this.x = ROTATION_CENTER.x + (ROTATION_RADIUS-80) * Math.cos(this.angle);
        this.y = ROTATION_CENTER.y + (ROTATION_RADIUS-80) * Math.sin(this.angle);
    };
    CircleRotation5.prototype.paint = function (context){
        context.save();
/*		var ag_img= new Image();
		ag_img.src = "images/Hulu.png";
		var pat=context.createPattern(ag_img,"repeat");		*/
    ...
    CircleBullet.prototype.paint = function (context){
        ...
        context.fillStyle = BULLET_TEXT_STYLE;		/**BULLET_TEXT_STYLE**/
    ...
    Game.prototype = {
        ...
        init:function (){
            ...
            if(!this.centerCircle)
                this.centerCircle = new CircleCenter("#f0cb00");
            var self = this;
            this.mobileTouch = new JicemoonMobileTouch(this.canvas,{tap: function (evt){
                self.tapHandle.call(self, evt);
            }});
            this.imageTouch = new JicemoonMobileTouch(this.canvas,{tap: function (evt){
                self.ImageToCanvas.call(self, evt);
            }});
        },
        gameStart:function (){
            this.level = 1;
                ...
                if(!this.isCanTap){
                    ...
                    if(tempBC.y <=  ROTATION_CENTER.y + ROTATION_RADIUS + 2 * RADIUS_SMALL){
                        if(this.checkCollision.call(this,tempBC)){
                            ...
                            this.rotationCircles.push(new CircleRotation2(Math.PI * 0.5, FILL_STYLE));
                            this.rotationCircles.push(new CircleRotation3(Math.PI * 0.5, FILL_STYLE));
                            this.rotationCircles.push(new CircleRotation4(Math.PI * 0.5, FILL_STYLE));
                            this.rotationCircles.push(new CircleRotation5(Math.PI * 0.5, FILL_STYLE));							
        ...
        levelChange:function (){
            ...
            this.bulletCircles = [];
            var i,lens,levelA,tempCircle,ta,tempCircle2,tempCircle3,tempCircle4,tempCircle5;
            ...
            for(i = 0; i < lens; i++){
                ...
                tempCircle2 = new CircleRotation2(ta*i,FILL_STYLE);
                tempCircle3 = new CircleRotation3(ta*i,FILL_STYLE);
                tempCircle4 = new CircleRotation4(ta*i,FILL_STYLE);
                tempCircle5 = new CircleRotation5(ta*i,FILL_STYLE);				
                this.rotationCircles.push(tempCircle);
                this.rotationCircles.push(tempCircle2);
                this.rotationCircles.push(tempCircle3);
                this.rotationCircles.push(tempCircle4);
                this.rotationCircles.push(tempCircle5);				
            }
