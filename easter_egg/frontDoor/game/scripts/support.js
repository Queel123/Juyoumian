...
function get_number_background_img(number) {
    switch (number) {
        ...
        case 512: return "url(images/picture9.png)"; break;
        case 1024: return "url(images/picture10.png)"; break;
        case 2048: return "url(images/picture11.png)"; break;
        case 4096: return "url(images/picture12.png)"; break;
        case 8192: return "url(images/picture13.png)"; break;
    }
    return 'black';
}
//获得相应数字的颜色
