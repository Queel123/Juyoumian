...
function init() {
    ...
    for (var i = 0; i < 2; i++) {
        for (var j = 0; j < 5; j++) {
            var shadow_cell = $('#shadow_cell_' + i + '_' + j);
            shadow_cell.css('top', get_pos_top(i, j));
            shadow_cell.css('left', get_pos_left(i, j));
        }
    }	
    for (var i = 0; i < 4; i++) {
        board[i] = new Array();
    ...
    for (var i = 0; i < 4; i++) {
        for (var j = 0; j < 4; j++) {
            ...
            if (board[i][j] == 0) {
				...
				number_cell.css('background-image', get_number_background_img(board[i][j]));
...
function unlock() {
    for (var i = 0; i < 4; i++) {
        for (var j = 0; j < 4; j++) {	
			if (board[i][j]==2) {
				$("#shadow_cell_0_0").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==4) {
				$("#shadow_cell_0_1").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==8) {
				$("#shadow_cell_0_2").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==16) {
				$("#shadow_cell_0_3").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==32) {
				$("#shadow_cell_0_4").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==64) {
				$("#shadow_cell_1_0").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}	
			if (board[i][j]==128) {
				$("#shadow_cell_1_1").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==256) {
				$("#shadow_cell_1_2").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==512) {
				$("#shadow_cell_1_3").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}
			if (board[i][j]==1024) {
				$("#shadow_cell_1_4").css('background-image', get_number_background_img(board[i][j]));
			}
			else {
			}			
		}
